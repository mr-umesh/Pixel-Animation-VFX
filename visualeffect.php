...
<head>
    ...
    <title>PIXL Visual Effects - Visual Effects</title>
...
<section>
    <div class="visual-section-one">
        <div class="">
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-6 col-md-6 p-0"> 
                    <div class="visul-img">
                        <img src="images/visualEffect/visual.jpg"  class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-6 col-md-6 p-0">
        ...
        <div class="button-section">
             <button class="btn-btn-btn"><i class='fas fa-chevron-circle-down'></i></button>
        </div>
    </div> 
</section>
        ...
        <div id="carouselExampleControlsNoTouching" class="carousel slide " data-bs-touch="false" data-bs-interval="false">
            <div class="carousel-inner wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="carousel-item">
                    <img src="images/visualEffect/owl-2.png" class="" alt="...">
                </div>
                <div class="carousel-item">
                ...
                <div class="col-12 col-lg-4 col-sm-4 col-md-4  wow rollIn" data-wow-duration="0.5s" data-wow-delay="0.3s">
                    ...
                    <!-- <div class="d-flex justify-content-center">
                        <video autoplay muted width="320" height="270" class="card bg-dark border-0" controls>
                            <source src="video/game-1.mp4" type="video/mp4">
                        </video>
                    </div> -->
                        <div class="thumb mt-4">
                            <img src="images/visualEffect/unravel.jpg" alt="" class="">
                                <a href="https://www.youtube.com/watch?v=LPi-_phHzRw" target="_blank">
                    ...
                    <div class="col-12 col-lg-4 col-sm-4 col-md-4  wow rollIn" data-wow-duration="0.5s" data-wow-delay="0.9s">
                        ...
                        <div class="thumb">
                            <img src="images/visualEffect/read-dead.jpg" alt="" class="thumb-3" height="200px" width="379">
                                <a href="https://www.youtube.com/watch?v=0d-U2QL2Qvc" target="_blank" >
                            <i class="fa fa-play-circle  button-three"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-6 wow fadeInLeft" data-wow-delay="0.5s">
                    <div class="img-effect">
                        ...
                        <div class="text-vfx-shot-two d-flex justify-content-center">
                            <h3 class="">EPISODE 2 VFX SHOT</h3>
                        </div>
                    </div>
                </div>
